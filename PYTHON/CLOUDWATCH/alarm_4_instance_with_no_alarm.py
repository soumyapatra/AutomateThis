...
alarm_inst_ids = get_alarm_inst(REGION)
inst_ids = get_inst_ids(REGION)

for instance in inst_ids:
    if instance not in alarm_inst_ids:
        print(instance)
        ...
        if check_bi_tag(instance):
            ...
            if check_cwagent_tag(instance):
                print(put_mem_cwagent_alarm(instance, ENV, SNS_ARN, name))
                print(put_swap_cwagent_alarm(instance, ENV, SNS_ARN, name))
            else:
            ...
            if check_cwagent_tag(instance):
                ...
                print(put_swap_cwagent_alarm(instance, ENV, ALERT_SNS_ARN, name))
            else:
