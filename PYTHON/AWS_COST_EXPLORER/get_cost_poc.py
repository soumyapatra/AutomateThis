...
def main_handler(event=None, context=None):
    billing_unit_tag = ["gr_production", "gr_production"]
    group_by_tag = "Application"
    costexplorer = CostExplorer(CurrentMonth=False)
    costexplorer.addEc2Report(Name="Production GR", GroupBy=[{"Type": "DIMENSION", "Key": "SERVICE"}],
                              Style='Total',
                              TagKey=group_by_tag, TagVal=billing_unit_tag)
    costexplorer.getTotalReport(tagKey="billing_unit", tagVal=billing_unit_tag)
    costexplorer.getTotalReport(tagKey="billing_unit", tagVal=billing_unit_tag)
