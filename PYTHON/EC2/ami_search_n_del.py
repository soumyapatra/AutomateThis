...
try:
    ...
    upload_to_s3(file_path, 'stage.xxxxxxxx.sonartest', s3_key)
    ...
    f.write(error)
    f.close()
    subprocess.call(f'mail -s "Error in Stage AMI Deletion Cron" soumyaranjan.patra@xxxxxxxx.com < {file_path}',shell=True)
