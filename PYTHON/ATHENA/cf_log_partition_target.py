...
cf_dict = [{'id': 'E1FRK1NHP0CKPZ', 'table': 'cloudfront_logs_temp', 'db': 'cloudfront_logs',
            's3_log': 's3://xxxxxxxx-my11circle-logs/structured/E1FRK1NHP0CKPZ'}]
...
def lambda_handler(event, context):
    ...
    for item in cf_dict:
        if item['id'] == id:
            ...
            database = item['db']
            s3_location = item['cf_s3_location']
